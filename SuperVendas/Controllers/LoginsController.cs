...
namespace SuperVendas.Controllers
{
    public class LoginsController : Controller
    {
        ...
        {
            var dBContext = _context.Login.Include(l => l.AccessLevel);
        ...
        public async Task<IActionResult> Create([Bind("LoginId,Username,Password,AccessLevelId")] Login login)
        {
            ...
            ViewData["AccessLevelId"] = new SelectList(_context.AccessLevel, "AccessLevelId", "AccessLevelName", login.AccessLevelId);
            return View(login);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LoginId,Username,Password,AccessLevelId")] Login login)
        {
            if (id != login.LoginId)
            {
                return NotFound();
